...
class Agent():
    def __init__(self,gamma,epsilon,lr,input_dims,batch_size,num_actions,max_mem_size=100000,eps_end=0.01,eps_dec=2e-4):
        self.gamma=gamma
        ...
        self.Q_eval=DeepQNetwork(n_actions=num_actions,lr=lr,input_dims=input_dims,fc1_dims=256,fc2_dims=256)
